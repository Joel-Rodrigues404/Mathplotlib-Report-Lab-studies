...
bar_labels = ['red', 'blue', 'red', 'orange', 'blue', 'red', 'orange', 'blue', 'orange', 'blue']


x = ["algo", "algo2", "algo3", "algo4", "algo5", "algo6", "algo7", "algo8", "algo9", "algo10"]
...
plt.xticks(range(len(x)), rotation=23, fontsize=12, color='black', fontweight='bold', ha='center')
